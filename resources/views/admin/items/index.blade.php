...
<div class="admin-page">
    ...
    <div class="filters-section">
        <form method="GET" action="{{ route('admin.items') }}" class="filters-form">
            <div class="filters-row">
                ...
                <div class="filter-group filter-buttons">
                    ...
                    <a href="{{ route('admin.items') }}" class="btn-reset">Сброс</a>
                </div>
            </div>
        </form>
    </div>
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->title }}</td>
                    <td>
                        <span class="badge badge-{{ $item->activity_type }}">
                            {{ $item->activity_type }}
                        </span>
                    </td>
                    <td>{{ $item->price }} ₽</td>
                ...
                @empty
                <tr>
                    <td colspan="6" style="text-align: center; padding: 40px;">Нет карточек аренды</td>
                </tr>
                @endforelse
            </tbody>
        </table>
