            ...
            <div class="container">
                <div class="footer-content">
                    <div class="footer-section">
                        <h4>О компании</h4>
                        <p>Аренда гидроциклов и водных маршрутов в Санкт-Петербурге. Яркие эмоции и незабываемые впечатления!</p>
                    </div>
                    
                    <div class="footer-section">
                        <h4>Контакты</h4>
                        <p>📍 Санкт-Петербург, наб. реки Невы</p>
                        <p>📞 +7 (999) 000-00-00</p>
                        <p>✉️ info@jetski-spb.ru</p>
                    </div>
                    
                    <div class="footer-section">
                        <h4>Режим работы</h4>
                        <p>Ежедневно: 10:00 - 22:00</p>
                        <p>Летний сезон: 09:00 - 23:00</p>
                    </div>
                </div>
                
                <div class="footer-bottom">
                    <p>&copy; {{ date('Y') }} Аренда гидроциклов. Все права защищены.</p>
                </div>
            </div>
        </footer>
    @endif
